...
export default function Home() {
  return (
    <div className="min-h-[100svh] flex flex-col lg:flex-row items-stretch gap-6 px-4 py-6 sm:px-6 sm:py-8 lg:px-12 lg:py-12">
        ...
        <div className="absolute bottom-6 left-6 z-10">
          <ul className="flex gap-4">
            <li className="border-2 border-gray-400/50 rounded-full p-2 w-10 h-10 flex items-center justify-center hover:bg-white hover:border-transparent transition-all duration-300 group">
              <Link
                target="_blank"
                href="https://www.instagram.com/sushibysugi/?igsh=eXYxNXkwNHMwbW94&utm_source=qr#"
              >
            ...
            <li className="border-2 border-gray-400/50 rounded-full p-2 w-10 h-10 flex items-center justify-center hover:bg-white hover:border-transparent transition-all duration-300 group">
              <Link
                target="_blank"
                href="https://www.tiktok.com/@sushibysugi?_t=ZG-904XIarYtxw&_r=1"
              >
      ...
      <div className="lg:w-1/4 w-full flex flex-col gap-4">
        ...
        >
          <div className="relative w-full h-40 lg:h-full rounded-2xl overflow-hidden">
            <Image
            ...
            <div className="absolute inset-0 flex items-end p-3">
              <h3 className="text-white text-3xl font-medium drop-shadow-md">
                Private dining
              </h3>
            </div>
          </div>
